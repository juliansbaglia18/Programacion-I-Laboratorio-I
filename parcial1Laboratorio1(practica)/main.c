    ...
    do
    {
        ...
        case '2':
            ...
            case '4':
                ...
                break;
            case '5':
                mostrarPeliculasConActores(peliculas, actores, MAX_ACTORES, MAX_PELICULAS);
                break;
            default:
        ...
        case '4':
            ...
            break;
        case '5':
            actorDeMasPeliculas(peliculas,actores, MAX_PELICULAS, MAX_ACTORES);
            actoresEnPeliculas(peliculas, actores, MAX_ACTORES, MAX_PELICULAS);
            aniosDePeliculas(peliculas, actores, MAX_ACTORES, MAX_PELICULAS);
            actoresDeUnGenero(peliculas, actores, MAX_ACTORES, MAX_PELICULAS);
            system("pause");
            system("cls");
